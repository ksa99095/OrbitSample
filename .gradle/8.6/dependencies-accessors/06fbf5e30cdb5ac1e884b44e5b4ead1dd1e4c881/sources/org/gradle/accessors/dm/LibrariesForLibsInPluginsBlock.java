...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>orbit</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>orbit</b> with value <b>9.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltPluginAccessors extends PluginFactory {
        private final HiltGradlePluginAccessors paccForHiltGradlePluginAccessors = new HiltGradlePluginAccessors(providers, config);

        public HiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.hilt.gradle</b>
         */
        public HiltGradlePluginAccessors getGradle() {
            return paccForHiltGradlePluginAccessors;
        }

    }

    public static class HiltGradlePluginAccessors extends PluginFactory {

        public HiltGradlePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>hilt.gradle.plugin</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("hilt.gradle.plugin"); }
    ...
    public static class KotlinAndroidPluginAccessors extends PluginFactory {

        public KotlinAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>kotlin.android.ksp</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKsp() { return createPlugin("kotlin.android.ksp"); }
